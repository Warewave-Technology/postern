    ...
    <form className="local-signin" onSubmit={submit}>
      ...
      <label>
        ...
        <input
          type="password"
          value={secret}
          // ⚠️ current-password DEĞİL: tarayıcının parola yöneticisine
          // bunu bir parola diye kaydettirmek, kullanıcıyı "parola"
          // zihniyetine iten ilk adım.
      ...
      <main className="center">
        <div className="center-card">
          ...
          */}
          ...
          {methods && !methods.oidc && !methods.local && (
