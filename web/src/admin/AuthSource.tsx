...
const BLURB: Record<string, string> = {
  local:
    "Accounts created on the bastion host with `postern admin issue`. Nobody else can sign in to the panel, and only these accounts can be administrators.",
        ...
        <>
          ...
          */}
          <p className="note">
            ...
            <br />
            followed by <code>postern admin issue &lt;name&gt;</code> if no
            local administrator has a secret.
          </p>
        </>
      )}
    </section>
