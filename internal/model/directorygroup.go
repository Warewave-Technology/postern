 ...
 * grupları gruba çeviren taraf (internal/store) buna bakıyor ve auth
 ...
 * hiçbir gruba eşleşmiyor, ProvisionUser hesabı AÇMIYOR ve kullanıcı
 * kapıda kalıyor — yöneticinin elinde onu düzeltecek bir tutamak bile
 * olmadan. Bu grup o tutamağı veriyor: yönetici `unknown`'ı bir gruba
 * eşler, kullanıcı içeri girer ve doğru grubuna elle atanır.
 */
const UnknownGroup = "unknown"

/*
 * ResolvedGroups, çözülmüş bir grup listesini gruba çevrilmeye hazırlar.
 *
